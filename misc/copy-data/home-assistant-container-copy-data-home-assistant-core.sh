...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/if-you-want-peace-prepare-for-war/proxmox/master/misc/copy-data/home-assistant-container-copy-data-home-assistant-core.sh)"
