...
qm set $VMID \
  ...
  -boot order=scsi0 \
  -serial0 socket \
  -description "<div align='center'><a href='https://tteck.github.io/Proxmox/'><img src='https://raw.githubusercontent.com/if-you-want-peace-prepare-for-war/proxmox/master/misc/images/logo_sm.png'/></a>

  # Debian 12 VM

  <a href='https://ko-fi.com/X8X37FUGU'><img src='https://img.shields.io/badge/&#x2615;-Buy me a coffee-blue' /></a>
  </div>" >/dev/null
...
echo "More Info at https://github.com/if-you-want-peace-prepare-for-war/proxmox/discussions/1988"
